<template>
  ...
  <header class="main-header header-style-two" :class="{ 'moblie-search-active': isSearch }">
    ...
    <div class="auto-container">
      <div class="header-top">
        <div class="inner-box">
          ...
          <div class="top-right">
            <ul class="social-icon-one">
              <li>Follow Us :</li>
              <li><NuxtLink to="#"><i class="fab fa-facebook"></i></NuxtLink></li>
              <li><NuxtLink to="#"><i class="fab fa-twitter"></i></NuxtLink></li>
              <li><NuxtLink to="#"><i class="fa-brands fa-linkedin"></i></NuxtLink></li>
              <li><NuxtLink to="#"><i class="fab fa-youtube"></i></NuxtLink></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="main-box">
          <div class="logo-box">
            <div class="logo"><NuxtLink to="/"><img src="/images/logo-v5-black.png" alt="" title="Hoexr"></NuxtLink></div>
