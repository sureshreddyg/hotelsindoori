<template>
  <LayoutPageTitle title="Banquets" />
          ...
          <div class="inner-column">
            <div class="image-box">
              <figure class="image overlay-anim">
                <img src="/images/property/board-room-5.jpg" alt="" />
              </figure>
            </div>
          </div>
        </div>
      ...
      <div class="row feature-row g-0 wow slideInUp" data-wow-delay="200ms">
        ...
        <div class="image-column col-lg-4 col-md-12 col-sm-12">
          <div class="inner-column">
            <div class="image-box">
              <figure class="image overlay-anim">
                <img src="/images/property/hall-1.1.jpg" alt="" />
              </figure>
            </div>
          </div>
        </div>
      ...
      <div class="row feature-row g-0 wow slideInUp" data-wow-delay="300ms">
        <div class="image-column col-lg-4 col-md-12 col-sm-12">
          <div class="inner-column">
            <div class="image-box">
              <figure class="image overlay-anim">
                <img src="/images/property/hall-2.2.jpg" alt="" />
              </figure>
            </div>
          </div>
        </div>
